...
class PublicController(
    ...
    @PermitAll
    @GetMapping("/authors/cursor")
    fun getAuthorsCursor(
        ...
        val cursorResponse = authorService.getAuthorsCursor(CursorPageRequest(cursor, size, sortBy))
        val body =
            CursorPageResponse(
    ...
    fun searchBooksCursor(
        ...
        val filter = BookFilter(title, isbn, BookGenre.getEnumValue(genre), author)
        val cursorResponse = bookService.searchBooksCursor(filter, CursorPageRequest(cursor, size, sortBy))
        val body =
            CursorPageResponse(
